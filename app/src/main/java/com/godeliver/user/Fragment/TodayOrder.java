...
import com.godeliver.user.Activity.MyFirebaseRegister;
...
*/
        ...
        private void order_OutDelivery(final String saleid) {
            ...
            CustomVolleyJsonRequest jsonObjectRequest = new CustomVolleyJsonRequest(Request.Method.POST, dOutforDelivery, params, new Response.Listener<JSONObject>() {
                @Override
                public void onResponse(JSONObject response) {
